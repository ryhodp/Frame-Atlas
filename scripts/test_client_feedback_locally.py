...
Boots the server against a throwaway database (same trick
...
def main():
    ...
    spec = importlib.util.spec_from_file_location('test_app_feedback', os.path.join(REPO, "backend", "app.py"))
